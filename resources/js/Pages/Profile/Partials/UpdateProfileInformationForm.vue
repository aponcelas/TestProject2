...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Informació personal</h2>

            <p class="mt-1 text-sm text-gray-600">
                Actualitza la informació del perfil del teu compte i l'adreça de correu electrònic.
            </p>
        </header>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="text-sm mt-2 text-gray-800">
                    La vostra adreça electrònica no està verificada.
                ...
                <div v-show="status === 'verification-link-sent'" class="mt-2 font-medium text-sm text-green-600">
                    S'ha enviat un nou enllaç de verificació a la vostra adreça electrònica.
                </div>
            </div>
