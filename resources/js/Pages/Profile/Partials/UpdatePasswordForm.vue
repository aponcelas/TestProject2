...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">Actualitzar contrasenya</h2>

            <p class="mt-1 text-sm text-gray-600">
                Assegureu-vos que el vostre compte està utilitzant una contrasenya llarga i aleatòria per mantenir-se
                segur.
            </p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password" value="Contrasenya nova" />
