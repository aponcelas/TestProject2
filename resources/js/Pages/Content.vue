...
function addCourse() {
    showEditorModal.value = false;
    form.post(route("content.add", form));
}
            ...
            <div class="relative flex flex-col items-center justify-center p-10">
                <div class="relative w-full">
                    <h1
                        ...
                        EducatiuCat: Continguts</h1>
                    <p
                        class="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 text-center">
                        Benvingut a l'àrea de continguts d'EducatiuCat, on pots gestionar els teus continguts de manera
                        eficient
                        i senzilla.
                        Aquí trobaràs totes les eines necessàries per crear, editar i eliminar continguts, així com per
                        mantenir actualitzada la teva oferta educativa.
                        Comença a explorar i potenciar els teus continguts avui mateix!</p>
                    <ContentCard v-for="content in content" :key="content.id" :content="content"
    ...
    <Modal :show="showEditorModal" @close="closeModal">
        <div class="p-6">
            <h2 class="text-sm font-bold text-gray-900 mb-4 flex justify-center items-center">
                <span>Afegir contingut:</span>
                <span class="text-red ml-1">{{ form.title }}</span>
            </h2>
            <div class="mb-4">
                <label class="block font-bold text-gray-900 text-sm">Nom del contingut: </label>
            ...
            <div class="mb-4">
                ...
                <div class="border-container bg-white mt-2">
                    ...
                    <editor-content :editor="editor" class="m-4 text-sm" v-model="form.content" />
                </div>
            </div>
            <div class="mb-4">
